  ...
  return (
    <article className="bg-emerald-50 dark:bg-slate-800 p-6 rounded-lg shadow-md hover:shadow-xl dark:shadow-slate-700/60 dark:hover:shadow-slate-600/70 dark:border dark:border-slate-700 transition-all duration-300 flex flex-col h-full">
      {type === "blender" && mainImage ? (
        <img
          src={mainImage}
          // SEO: Updated alt text to be temporary for review
...
function App() {
  ...
  const personStructuredData = {
    ...
    image: "https://filipej.dev/og-image.png", // Make sure this image exists and is accessible
    ...
    sameAs: [
      ...
      // "https://scholar.google.com/citations?user=YOUR_GOOGLE_SCHOLAR_ID", // Replace with actual ID
      // "https://www.researchgate.net/profile/YOUR_RESEARCHGATE_PROFILE", // Replace with actual profile
    ],
    description:
